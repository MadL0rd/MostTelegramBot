...
class BikeScooterCategoryChoice(MenuModuleInterface):
    ...
    async def handleModuleStart(self, ctx: Message, msg: MessageSender) -> Completion:
        ...
        await msg.answer(
            ctx = ctx,
            text = self.storage.getTextConstant(textConstant.bikeScooterCategoryChoice),
    ...
    async def handleUserMessage(self, ctx: Message, msg: MessageSender, data: dict) -> Completion:
        ...
        self.storage.logToUserRequest(ctx.from_user,RequestCodingKeys.bikeScooterCategoryChoice, messageText)  
